...
import {
  ...
  renderApplication,
  renderModule
} from "./chunk-NUKMTOVU.js";
import "./chunk-KB3LHD3T.js";
...
__name(attachNodeGlobalErrorHandlers, "attachNodeGlobalErrorHandlers");
var _CommonEngineInlineCriticalCssProcessor = class _CommonEngineInlineCriticalCssProcessor {
...
__name(_CommonEngineInlineCriticalCssProcessor, "CommonEngineInlineCriticalCssProcessor");
var CommonEngineInlineCriticalCssProcessor = _CommonEngineInlineCriticalCssProcessor;
...
__name(printPerformanceLogs, "printPerformanceLogs");
...
__name(runMethodAndMeasurePerf, "runMethodAndMeasurePerf");
function noopRunMethodAndMeasurePerf(label, asyncMethod) {
  return asyncMethod();
}
__name(noopRunMethodAndMeasurePerf, "noopRunMethodAndMeasurePerf");
var SSG_MARKER_REGEXP = /ng-server-context=["']\w*\|?ssg\|?\w*["']/;
var _CommonEngine = class _CommonEngine {
  options;
...
__name(_CommonEngine, "CommonEngine");
var CommonEngine = _CommonEngine;
...
__name(isBootstrapFn, "isBootstrapFn");
...
__name(createWebRequestFromNodeRequest, "createWebRequestFromNodeRequest");
...
var _AngularNodeAppEngine = class _AngularNodeAppEngine {
...
__name(_AngularNodeAppEngine, "AngularNodeAppEngine");
var AngularNodeAppEngine = _AngularNodeAppEngine;
function createNodeRequestHandler(handler) {
  handler["__ng_node_request_handler__"] = true;
  return handler;
}
__name(createNodeRequestHandler, "createNodeRequestHandler");
...
__name(writeResponseToNodeResponse, "writeResponseToNodeResponse");
